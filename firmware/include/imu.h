...
namespace micromouse {
    ...
    private:
        ...
        int ReadThreeAxisData(char baseAddress,
                              float scaleFactor,
                              float& x,
                              float& y,
                              float& z);
    ...
    public:
        IMU(I2cDevice* i2c, char address);
